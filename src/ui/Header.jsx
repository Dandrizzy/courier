  ...
  return (
    <div className=' md:hidden block'>
      ...
      {open && <ul className=" px-4 bg-blue-600  text-slate-100 grid divide-y [&>*]:cursor-pointer ">
        ...
        {user?.id === 'd82350ef-5ec5-4768-a819-06d04b8b62b8' && <li className=' flex items-center gap-1 hover:bg-blue-400 rounded-sm py-8 hover:px-4 transition-all duration-500 hover:gap-2' onClick={() => {
          setOpen(isOpen => !isOpen);
          navigate('/dashboard');
