  ...
  return (
    <div className=" hidden items-center md:grid grid-cols-2 p-4 bg-blue-700 text-slate-100">
      ...
      <ul className=" lg:text-lg [&>*]:cursor-pointer flex justify-between">
        ...
        {user?.id === 'd82350ef-5ec5-4768-a819-06d04b8b62b8' && <li className=' flex items-center justify-center gap-1 hover:bg-neutral-200/20 transition-all duration-300 rounded-full px-2 py-0' onClick={() => {
